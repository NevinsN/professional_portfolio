  ...
  return (
    <header className={`App-header ${theme}`}>      
      ...
      <div className="content">
        <img 
          src={Headshot} 
          alt="Nicholas Nevins - Software Engineer Headshot" 
          className="profile-headshot"
        />
        
        {/* Changed <p> to <section> to allow for <div> and <ul> nesting */}
        <section className="bio-container">
          ...
          <div className="development-edge">
            <h3>Development Edge:</h3>
